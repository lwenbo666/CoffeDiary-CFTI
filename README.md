...
| 🗓 **日历贴纸** | 咖啡记录以拍立得贴纸形式贴在日历格子上，支持点击放大查看 |
...
├── app/
│   ├── src/main/
│   │   ├── assets/main.html      # 核心前端（日历/拍照/统计/CFTI）
│   │   ├── java/.../
...
2. **查看日历**：今日贴纸点击可放大，再次点击可删除
3. **查看统计**：底部导航切换到"统计"页，支持按本周/本月/本年筛选
4. **解锁 CFTI**：在 7 个不同日子记录咖啡后，自动生成咖啡人格报告
5. **生成海报**：在统计页 CFTI 区域点击"生成人格海报"保存到相册
